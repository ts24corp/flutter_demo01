...
class HomeDesign extends Container {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  GlobalKey txtKey = new GlobalKey();
  ...
  void _incrementCounter() {
    setState(() {
      ...
      _counter++;
      //Tạo renderbox lấy giá trị globalKey
      RenderBox renderText = txtKey.currentContext.findRenderObject();
      RenderBox renderBtn = btnKey.currentContext.findRenderObject();
      //In giá trị renderBox
